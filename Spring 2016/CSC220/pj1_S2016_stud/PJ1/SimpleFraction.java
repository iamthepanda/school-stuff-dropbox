...
public class SimpleFraction implements SimpleFractionInterface, Comparable<SimpleFraction> {
    ...
    public SimpleFraction(int num, int den) {
        // implement this method!
        if(den == 0) {
            throw new SimpleFractionException("Cannot create with denominator of zero");
        }
        this.num = num;
        this.den = den;
    ...
    public void setSimpleFraction(int num, int den) {
        if(den == 0) {
            throw new SimpleFractionException("Cannot set with denominator of zero");
        }
        // implement this method!
    ...
    public SimpleFractionInterface add(SimpleFractionInterface secondFraction) {
        // implement this method!
        // a/b + c/d is (ad + cb)/(bd)
        // this.num/this.den + other.num/other.den is (this.num*other.den + other.num*this.den)/(this.den*other.den)
        // return result which is a new SimpleFraction object
        SimpleFraction other = (SimpleFraction) secondFraction;
        int numerator = ((num * other.den) + (other.num * this.den));
        int denominator = (this.den * other.den);
        SimpleFraction simpleFraction = new SimpleFraction(numerator, denominator);
        simpleFraction.reduceSimpleFractionToLowestTerms();
    ...
    public SimpleFractionInterface divide(SimpleFractionInterface secondFraction) {
        ...
        if(denominator == 0) {
            throw new SimpleFractionException("Division by zero");
        }
    ...
    public SimpleFractionInterface getReciprocal() {
        ...
        // return result which is a new SimpleFraction object
        if(this.num == 0) {
            throw new SimpleFractionException("Reciprocal result in denominator zero");
        }
        return new SimpleFraction(this.den, this.num);
    }


    public boolean equals(Object other) {
        if(other instanceof SimpleFraction) {
            SimpleFraction f = (SimpleFraction) other;
    ...
    private void reduceSimpleFractionToLowestTerms() {
        ...
        int gcd = Math.abs(GCD(this.num, this.den));
