...
//		public static readonly string REMOTE_HOST = "54.69.245.208";
	...
	//C corresponds to to request, S corresponds to response
	public static readonly short CMSG_NUM_PLAYERS = 103;
    public static readonly short SMSG_NUM_PLAYERS = 203;
